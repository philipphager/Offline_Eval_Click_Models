...
from modules.click_models import ClickModel, PBM, UBM, DBN, ARM, NCM, CACM, NEHBM, RandomClickModel, TopPop, CoCM
...
if __name__ == '__main__':
    ...
    main_parser.add_argument('--cm', type=str, required = True, 
                                ...
                                'DBN', 'ARM', 'NCM', 'CACM', 'NEHBM'], help='Name of the click model.')
