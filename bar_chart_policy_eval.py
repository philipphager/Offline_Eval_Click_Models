...
configurations = {"TCM" : ["PBM", "UBM", "DBN", "NCM", "ARM", "NEHBM"], 
...
ax1.bar(np.arange(6), CTRs["CoCM_-lambdamart_MAXREWARD"], width = 0.3, label = "PL-λMART", color = "sandybrown")
...
ax2.set_xticklabels(["PBM", "UBM", "DBN", "NCM", "NEHBM", "ARM"])
...
ax1.bar(np.arange(6), CTRs["CoCM_mismatch_-lambdamart_MAXREWARD"], width = 0.3, label = "PL-λMART", color = "sandybrown")
...
ax2.bar(np.arange(6), CTRs["CoCM_mismatch_-lambdamart_MAXREWARD"], width = 0.3, label = "PL-λMART", color = "sandybrown")
